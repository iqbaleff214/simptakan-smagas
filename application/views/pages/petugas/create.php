        ...
        <form class="form-horizontal" method="POST" action="<?= current_url(); ?>" enctype="multipart/form-data">
            <div class="box-body">
                ...
                <div class="form-group <?= isInvalid('username') ?>">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="username" name="username" placeholder="Masukkan Username (Jika kosong, username disamakan dengan NIP)" value="<?= set_value('username'); ?>">
                    </div>
                </div>
