...
<html lang="en">
  ...
  <body>
    ...
    <table style="width: 100%;">
        <tr>
            <td rowspan="5">
                <img src="<?= $foto; ?>" alt="<?= $item['nama']; ?>" class="img-thumbnail">
            </td>
            <td></td>
            <td></td>
            <td></td>
        ...
        <tr>
            <td style="width: 30%; font-weight: 800;">Nama</td>
            <td style="width: 40px;">:</td>
            <td><?= $item['nama'] ?></td>
        </tr>
        <tr>
            <td style="font-weight: 800;">NIS</td>
            <td>:</td>
            <td><?= $item['nis'] ?></td>
        </tr>
        <tr>
            <td style="font-weight: 800;">Kelas</td>
            <td>:</td>
            <td><?= $item['kelas'] ?></td>
        </tr>
        <tr>
