        ...
        <form class="form-horizontal" method="POST" action="<?= current_url(); ?>">
            <div class="box-body">
                <div class="form-group <?= isInvalid('penerbit') ?>">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="penerbit" name="penerbit" placeholder="Rak" value="<?= set_value('penerbit', $item['penerbit']); ?>">
                    </div>
                </div>
                <div class="form-group <?= isInvalid('no_telp') ?>">
                    <label for="no_telp" class="col-sm-2 control-label">No. Telp</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="no_telp" name="no_telp" placeholder="Masukkan Nomor Telepon" value="<?= set_value('no_telp', $item['no_telp']); ?>">
                    </div>
                </div>
                ...
                <div class="form-group <?= isInvalid('keterangan') ?>">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="keterangan" name="keterangan" placeholder="Masukkan keterangan" value="<?= set_value('keterangan', $item['keterangan']); ?>">
                    </div>
                </div>
            </div>
            <!-- /.box-body -->
