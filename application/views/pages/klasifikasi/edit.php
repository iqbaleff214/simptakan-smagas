        ...
        <form class="form-horizontal" method="POST" action="<?= current_url(); ?>">
            <div class="box-body">
                <div class="form-group <?= isInvalid('kode_klasifikasi') ?>">
                    <label for="kode_klasifikasi" class="col-sm-2 control-label">Klasifikasi</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="kode_klasifikasi" name="kode_klasifikasi" placeholder="Rak" value="<?= set_value('kode_klasifikasi', $item['kode_klasifikasi']); ?>" disabled>
                    </div>
                </div>
